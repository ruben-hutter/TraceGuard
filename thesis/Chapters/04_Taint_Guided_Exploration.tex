...
\begin{algorithm}[H]
    \caption{Taint Introduction at Input Functions}\label{alg:taint_introduction}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
    \caption{Taint Status Check}\label{alg:taint_status_check}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
    \caption{State Classification and Prioritization}\label{alg:state_classification}
\begin{algorithmic}[1]
...
\begin{algorithm}[H]
    \caption{Taint Score Calculation}\label{alg:taint_score_calculation}
\begin{algorithmic}[1]
\Require State $s$
